...
function Chronometer:OnInitialize()
	...
	self.textures = {
		...
		["ruben"] = "Interface\\Addons\\Chronometer\\Textures\\Ruben",
		["luna"] = "Interface\\Addons\\Chronometer\\Textures\\Luna",
	}
			...
			bar = {
				...
				args = {
					...
					texture = {
						...
						validate = { "default", "banto", "cilo", "charcoal", "diagonal", "fifths", "glaze", "perl", "smooth", "smoothv2","ruben","luna" },
					},
					color = {
