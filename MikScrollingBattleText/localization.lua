...
MikSBT.AVAILABLE_FONTS = {
 ...
 [23] = {Name="Roboto-Black", Path="Interface\\Addons\\MikScrollingBattleText\\Fonts\\Roboto-Black.ttf"},
 [24] = {Name="TakeAShot", Path="Interface\\Addons\\MikScrollingBattleText\\Fonts\\BlackOpsOne.ttf"},
};
