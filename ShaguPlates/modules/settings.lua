ShaguPlates:RegisterModule("gui", "vanilla:tbc", function ()
  ...
  do -- GUI Frame
    ...
    ShaguPlates.gui.title:SetFont(ShaguPlates.media["font:Hooge.ttf"], 10)
    ShaguPlates.gui.title:SetText("|cff33ffccShagu|rPlates")
    ...
    ShaguPlates.gui.version:SetFont(ShaguPlates.media["font:Myriad-Pro.ttf"], 10)
  ...
  do -- DropDown Menus
    ...
    ShaguPlates.gui.dropdowns = {
      ...
      ["uf_bartexture"] = {
		...
		"Interface\\AddOns\\ShaguPlates\\img\\bar_luna",
  ...
  do -- Generate Config UI
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(nil, T["cooldown"], nil, nil, "header")
